...
<!-- Mirrored from gsrthemes.com/highstand/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Apr 2016 16:24:29 GMT -->
<head>
...
<div class="site_wrapper">
                    ...
                    <div id="navbar-collapse-1" class="navbar-collapse collapse pull-right">
                        ...
                        <nav>
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown"><a href="{{ asset('/about') }}" class="dropdown-toggle active">About Us</a>
                                </li>
    ...
    <div class="clearfix"></div>
    <div class="feature_section53">
        <div class="container">
            <h4 class="caps light">Our Trusted Partners</h4>
            <div class="clearfix margin_bottom3"></div>
            <ul>
                <li><img src="images/clogo1.jpg" alt=""/></li>
                <li><img src="images/clogo2.jpg" alt=""/></li>
                <li><img src="images/clogo3.jpg" alt=""/></li>
                <li><img src="images/clogo4.jpg" alt=""/></li>
                <li><img src="images/clogo5.jpg" alt=""/></li>
                <li class="last"><img src="images/clogo6.jpg" alt=""/></li>
            </ul>
        </div>
    </div>
    <!-- end feature_section 53 -->
